...
- start external services `docker-compose -f src/main/docker/deps.yml up -d`
- start app `./mvnw`
...
To build the final jar and optimize the schattenbuchhaltung application for production, run:
