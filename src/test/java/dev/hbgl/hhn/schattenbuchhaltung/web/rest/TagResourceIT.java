...
class TagResourceIT {
    ...
    private static final TagKind DEFAULT_TYPE = TagKind.TEXT;
    private static final TagKind UPDATED_TYPE = TagKind.CUSTOM;
     ...
     *
     * @see dev.hbgl.hhn.schattenbuchhaltung.repository.search.TagSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    void putNewTag() throws Exception {
        ...
        updatedTag.type(UPDATED_TYPE).text(UPDATED_TEXT);
    ...
    void partialUpdateTagWithPatch() throws Exception {
        ...
        partialUpdatedTag.type(UPDATED_TYPE).text(UPDATED_TEXT);
