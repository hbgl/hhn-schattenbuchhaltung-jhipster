...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, dev.hbgl.hhn.schattenbuchhaltung.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, dev.hbgl.hhn.schattenbuchhaltung.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, dev.hbgl.hhn.schattenbuchhaltung.domain.CostCenter.class.getName() + ".ledgerEntries2s");
            createCache(cm, dev.hbgl.hhn.schattenbuchhaltung.domain.CostCenter.class.getName() + ".ledgerEntries3s");
            createCache(cm, dev.hbgl.hhn.schattenbuchhaltung.domain.Division.class.getName());
