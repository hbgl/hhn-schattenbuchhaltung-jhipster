...
@Component({
  selector: 'jhi-tag-custom-value',
  templateUrl: './tag-custom-value.component.html',
})
export class TagCustomValueComponent implements OnInit {
  ...
  trackId(index: number, item: ITagCustomValue): number {
    return item.id!;
  }

  delete(tagCustomValue: ITagCustomValue): void {
    const modalRef = this.modalService.open(TagCustomValueDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.tagCustomValue = tagCustomValue;
